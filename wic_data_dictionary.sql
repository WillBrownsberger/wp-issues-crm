...
--
-- Host: localhost
-- Generation Time: Nov 30, 2014 at 07:13 PM
...
(39, 'address', 'address_line_1', 'address_line', 'text', 0, 'Street Address', 40, 0, 0, '', 0, 0, 0, '', 1, 'street_name', 0, '', 'wic-input', 'wic-label', '123', 0, 0),
...
(61, 'constituent', 'search_parms', 'match_level', 'select', 0, 'Name Match', 20, 0, 0, '', 0, 0, 0, '', 0, '', 1, '', 'wic-input', 'wic-label', '', 1, 0),
...
INSERT INTO `wp_wic_form_field_groups` (`group_id`, `entity_slug`, `group_slug`, `group_label`, `group_legend`, `group_order`, `initial_open`, `search_only`, `sidebar_location`) VALUES
(1, 'constituent', 'contact', 'Contact', '', 10, 1, 0, 0),
(5, 'constituent', 'case', 'Case Management', '', 30, 1, 0, 1),
(6, 'constituent', 'personal', 'Personal Info', '', 40, 0, 0, 1),
(7, 'constituent', 'registration', 'Codes', 'These fields are read only -- searchable, but not updateable.', 50, 0, 0, 1),
(10, 'activity', 'activity_note', 'Activity Note', '', 20, 0, 0, 0),
(11, 'address', 'address_line_1', 'Address Line 1', '', 10, 1, 0, 0),
(12, 'address', 'address_line_2', 'Address Line 2', '', 20, 0, 0, 0),
(13, 'email', 'email_row', 'Email Row', '', 10, 1, 0, 0),
(14, 'phone', 'phone_row', 'Phone Row', '', 10, 1, 0, 0),
(15, 'constituent', 'search_parms', 'Search Options', '\n\n', 25, 1, 1, 1),
(16, 'activity', 'activity', '', '', 10, 0, 0, 0),
(17, 'activity', 'activity_issue', '', '', 15, 0, 0, 0),
(18, 'issue', 'issue_content', 'Issue Content', '', 10, 1, 0, 0),
(19, 'issue', 'issue_classification', 'Classification', '', 20, 1, 0, 0),
(20, 'issue', 'issue_management', 'Issue Management', '', 30, 1, 0, 1),
(21, 'issue', 'issue_creation', 'Codes', 'These fields are not updateable except through the regular Wordpress admin screens.', 40, 0, 0, 1),
(22, 'constituent', 'comment', 'Latest Online Comments', 'Note: If the online user''s email is not in WP-Issues-CRM, the online activity will not be shown here.  Online activity shown here can only be altered through the WP backend.  ', 20, 0, 0, 0),
(23, 'comment', 'comment', 'Online Comments', '', 10, 0, 0, 0);
