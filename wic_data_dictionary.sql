...
(64, 'issue', 'issue_content', 'post_content', 'textarea', 0, 'Issue Content', 20, 0, 0, '', 0, 0, 0, '', 0, 0, 'post_content', 'wic-input', 'wic-label', ' . . . issue content . . .', 0),
(65, 'issue', 'issue_classification', 'tags', 'text', 0, 'Tags', 10, 0, 0, '', 0, 0, 0, '', 0, 0, 'tag', 'wic-input', 'wic-label', '', 0),
(66, 'issue', 'issue_classification', 'categories', 'text', 0, 'Categories', 20, 50, 0, 'individual', 0, 0, 0, '', 0, 0, 'cat', 'wic-input', 'wic-label', '', 0),
(67, 'issue', 'issue_content', 'post_title', 'text', 0, 'Issue Title', 10, 40, 0, 'individual', 0, 0, 0, '', 0, 0, 'post_title', 'wic-input', 'wic-label', '', 0),
(68, 'issue', 'issue_management', 'issue_staff', 'select', 0, 'Staff', 10, 10, 0, '', 0, 0, 0, '', 0, 0, '', 'wic-input', 'wic-label', '', 0),
(69, 'issue', 'issue_management', 'comments_status', 'select', 0, 'Comments', 20, 20, 0, '', 0, 0, 0, '', 0, 0, '', 'wic-input', 'wic-label', '', 0),
(70, 'issue', 'issue_management', 'follow_up_status', 'select', 0, 'Follow-up', 30, 30, 0, '', 0, 0, 0, '', 0, 0, '', 'wic-input', 'wic-label', '', 0),
(71, 'issue', 'issue_management', 'review_date', 'range', 1, 'Review Date', 40, 0, 0, '', 0, 0, 0, '', 0, 0, '', 'wic-input', 'wic-label', '', 0),
(72, 'issue', 'issue_creation', 'post_author', 'select', 0, 'Created By', 10, 0, 0, '', 0, 1, 0, '', 0, 0, 'author', 'wic-input', 'wic-label', '', 0),
(73, 'issue', 'issue_creation', 'post_date', 'range', 1, 'Created Date', 20, 0, 10, '', 0, 1, 0, '', 0, 0, 'date', 'wic-input', 'wic-label', '', 0),
(74, 'issue', 'issue_creation', 'post_status', 'select', 0, 'Visibility', 30, 60, 0, '', 0, 1, 0, '', 0, 0, 'post_status', 'wic-input', 'wic-label', '', 0),
(75, 'issue', 'issue_creation', 'ID', 'text', 0, 'Post ID', 40, 1, 0, '', 0, 1, 0, '', 0, 0, 'p', 'wic-input', 'wic-label', '', 0);
